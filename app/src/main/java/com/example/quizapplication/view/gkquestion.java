...
public class gkquestion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor data = Db.viewdatagk();
            ...
            questionAdapter adapter = new questionAdapter(gkquestion.this, question,optiona,optionb,optionc,optiond,answer);
