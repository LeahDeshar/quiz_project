...
public class Itquestion extends AppCompatActivity {
    ListView list;
...
//question=data.getString(0);
        ...
        questionAdapter adapter = new questionAdapter(Itquestion.this, question,optiona,optionb,optionc,optiond,answer);
