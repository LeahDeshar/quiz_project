...
import com.example.quizapplication.view.gkquestion;


public class Gkaddquestion extends AppCompatActivity {
    ...
    admindbhelper DB=new admindbhelper(Gkaddquestion.this);
    Playdb db=new Playdb(Gkaddquestion.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(queston.equals("")||optionA.equals("")||optionB.equals("")||optionC.equals("")||optionD.equals("")||Ans.equals("")){
                    Toast.makeText(Gkaddquestion.this, "Please enter all field", Toast.LENGTH_SHORT).show();
                }
                Boolean checkuser = DB.checkgkans(question);
                if(checkuser==true){
                    Toast.makeText(Gkaddquestion.this, "These question already inserted ", Toast.LENGTH_SHORT).show();

                }
                else {
                    if (Ans.equals(optionA)||Ans.equals(optionB)||Ans.equals(optionC)||Ans.equals(optionD))
                    {
                        Boolean checkinsert = DB.insertgk(question,optionA,optionB,optionC,optionD, Ans);
                        Boolean checkinsert1 = DB.insertplay(question, optionA, optionB, optionC, optionD, Ans);

                        if (checkinsert == true) {
                            if (checkinsert1 == true) {

                                Toast.makeText(Gkaddquestion.this, "Insert record Suceddfully", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(Gkaddquestion.this, "Error", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }else {
                        Toast.makeText(Gkaddquestion.this, "Answer should be equal to any one", Toast.LENGTH_SHORT).show();
                    }
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder alertbox = new AlertDialog.Builder(Gkaddquestion.this);
...
//String n=did.getText().toString();
                ...
                delete1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Boolean checkdelete=DB.deletedatagk(Ans);
                        if(checkdelete==true){
                            Toast.makeText(Gkaddquestion.this, "Delete record  Suceddfully", Toast.LENGTH_SHORT).show();
                        }
                        else{
                            Toast.makeText(Gkaddquestion.this, "Error", Toast.LENGTH_SHORT).show();
                        }
        ...
        viwe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(Gkaddquestion.this, gkquestion.class);
                startActivity(i);
            }
        });
        update.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(Gkaddquestion.this, Update.class);
                startActivity(i);
            }
        });
    }
