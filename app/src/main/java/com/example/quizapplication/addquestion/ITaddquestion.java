...
import com.example.quizapplication.view.Itquestion;
import com.example.quizapplication.admindbhelper;


public class ITaddquestion extends AppCompatActivity {
    ...
    String a;
    String[] topic={"Sports","History","GK","IT"};
    admindbhelper DB=new admindbhelper(ITaddquestion.this);
    Playdb db=new Playdb(ITaddquestion.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(queston.equals("")||optionA.equals("")||optionB.equals("")||optionC.equals("")||optionD.equals("")||Ans.equals("")){
                    Toast.makeText(ITaddquestion.this, "Please enter all field", Toast.LENGTH_SHORT).show();
                }
                Boolean checkuser = DB.checkitans(question);
                if(checkuser==true){
                    Toast.makeText(ITaddquestion.this, "These question already inserted ", Toast.LENGTH_SHORT).show();

                }
                else {
                    if (Ans.equals(optionA)||Ans.equals(optionB)||Ans.equals(optionC)||Ans.equals(optionD))
                    {
                        Boolean checkinsert = DB.insertit(question,optionA,optionB,optionC,optionD, Ans);
                        Boolean checkinsert1 = DB.insertplay(question, optionA, optionB, optionC, optionD, Ans);

                        if (checkinsert == true) {
                            if (checkinsert1 == true) {

                                Toast.makeText(ITaddquestion.this, "Insert record Suceddfully", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(ITaddquestion.this, "Error", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }else {
                        Toast.makeText(ITaddquestion.this, "Answer should be equal to any one", Toast.LENGTH_SHORT).show();
                    }
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder alertbox = new AlertDialog.Builder(ITaddquestion.this);
...
//String n=did.getText().toString();
                ...
                delete1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Boolean checkdelete=DB.deletedatait(Ans);
                        if(checkdelete==true){
                            Toast.makeText(ITaddquestion.this, "Delete record  Suceddfully", Toast.LENGTH_SHORT).show();
                        }
                        else{
                            Toast.makeText(ITaddquestion.this, "Error", Toast.LENGTH_SHORT).show();
                        }
        ...
        viwe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(ITaddquestion.this, Itquestion.class);
                startActivity(i);
            }
        });
        update.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(ITaddquestion.this, Update.class);
                startActivity(i);
            }
        });
