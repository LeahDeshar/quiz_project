...
public class Mathplay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        admindbhelper Db=new admindbhelper(Mathplay.this);
        ...
        Cursor data = Db.viewdatamathplay();
            ...
            public void onClick(View view) {
                ...
                if(index<=question.length() ) {
                    ...
                    if (a.isChecked()) {
                        ...
                        if (ans1.equals(oa)) {
                            Toast.makeText(Mathplay.this, "Correct", Toast.LENGTH_SHORT).show();
                            score++;
                        } else {
                            Toast.makeText(Mathplay.this, "Wrong", Toast.LENGTH_SHORT).show();
                            wrong++;
                        }
                    }
                    else if (b.isChecked()) {
...
//                        Toast.makeText(Sports.this, "Score is "+score, Toast.LENGTH_SHORT).show();
                                    ...
                                    Intent intent = new Intent(Mathplay.this, FinalResultActivity.class);
                                    String play = "Math";
                                    ...
                                    if (insert == true) {
                                        Toast.makeText(Mathplay.this, "insert sucessfull in history", Toast.LENGTH_SHORT).show();
                                    } else {
                                        Toast.makeText(Mathplay.this, "Error", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            }
                        });
