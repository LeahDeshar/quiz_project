...
public class Sportsplay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        admindbhelper Db=new admindbhelper(Sportsplay.this);
                ...
                public void onClick(View view) {
                    ...
                    if(index<=question.length() ) {
                        ...
                        if (a.isChecked()) {
                            ...
                            if (ans1.equals(oa)) {
                                Toast.makeText(Sportsplay.this, "Correct", Toast.LENGTH_SHORT).show();
                                score++;
                            } else {
                                Toast.makeText(Sportsplay.this, "Wrong", Toast.LENGTH_SHORT).show();
                                wrong++;
                            }
                        }
                        else if (b.isChecked()) {
...
//                        Toast.makeText(Sports.this, "Score is "+score, Toast.LENGTH_SHORT).show();
                                        ...
                                        Intent intent = new Intent(Sportsplay.this, FinalResultActivity.class);
                                        String play = "Sport";
                                        ...
                                        if (insert == true) {
                                            Toast.makeText(Sportsplay.this, "insert sucessfull in history", Toast.LENGTH_SHORT).show();
                                        } else {
                                            Toast.makeText(Sportsplay.this, "Error", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                }
                            });
            ...
            Toast.makeText(Sportsplay.this, "No questions found in the database.", Toast.LENGTH_SHORT).show();
            finish();
        }
